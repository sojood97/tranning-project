...
import {
   ...
   export class  Header extends Component{
    ...
    closeMenu1(event) {
        ...
        // if (!this.dropdownMenu.contains(event.target)) {
        //this.setState({ showMenu1: false, showMember: false }, () => {
           // document.removeEventListener("click", this.closeMenu);
        //});
        //}
    }
    ...
    <header className="board_header">
        ...
        <div className="board_header_right">
            <span className="board_icon" onClick={() => this.showMenu1 ()}><FontAwesomeIcon icon={faPlus} /></span>
            <span className="board_icon"><FontAwesomeIcon icon={faInfoCircle} /></span>
            <sapn className="board_icon"><FontAwesomeIcon icon={faBell} /></NavLink>
                                                    ...
                                                    <div className="actions_div">
                                                        <ul className="ull">
                                                            ...
                                                            <li className="lii">
                                                                ...
                                                                >
                                                                   Create Team...
                                                                  <p> A Team is a groupe of boards and people.
                                                                   use it to organize your company ,side hustel ,family ,or friends
                                                                   </p>
                                                                </NavLink>
                                                            </li>
                                                            <li className="lii">
                                                                ...
                                                                >
                                                                   ...
                                                                   <p>With Bussiness Class your team has more security,
                                                                       administartive controls ,and unlimited Power-Ups.
                                                                   </p>
